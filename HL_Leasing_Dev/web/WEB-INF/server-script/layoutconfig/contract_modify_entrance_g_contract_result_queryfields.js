...
{
	name : 'project_id_n',
	queryexpression : "t1.project_id_c like ${@project_id_n}"
},
{
	field : 'employee_id',
	queryoperator : "="
...
{
	name : 'project_document_type_in',
	queryexpression : "1=${@project_document_type_in} and t1.project_document_type in ('CARLS')"
},
{
	name :'data_class_no_in',
	queryexpression:"1=${@data_class_no_in} and t1.data_class='NORMAL' and t1.contract_status not in ('PENDING') and nvl(t1.con_maintain_flag,'N')!='Y' "
}
