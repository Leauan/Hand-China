...
--   COMMUNICATION_METHODS   乙方（法人）  通讯方式
...
--16.4其它：                                          。
 ...
 --所在地址选择
  ...
  select decode(nvl(hbma.city_id_n,2), '武汉市', 1, 2) as SELECT_SCHEME
   from hls_bp_master_address_lv hbma
